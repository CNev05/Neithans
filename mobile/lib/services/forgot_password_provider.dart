...
enum ForgotPasswordStep { phoneInput, otpVerification, resetPassword }
...
class ForgotPasswordProvider with ChangeNotifier {
  ...
  Future<bool> sendOtp() async {
    ...
    try {
      ...
      final sanitizedPhone = _phoneNumber.replaceAll(RegExp(r'\D'), '');
      ...
      await _auth.verifyPhoneNumber(
        ...
        verificationFailed: (FirebaseAuthException e) {
          if (e.code == 'operation-not-allowed' &&
            ...
            _errorMessage = 'Too many verification attempts. Please wait a few minutes before trying again.';
          } else {
  ...
  Future<bool> resetPassword(String newPassword) async {
    ...
    if (user == null) {
      _errorMessage = 'Please verify your phone number before resetting the password.';
      notifyListeners();
      return false;
    }
    ...
    try {
      ...
      _errorMessage = e.message ?? 'Unable to reset password.';
      return false;
    } catch (e) {
      _errorMessage = e.toString();
      return false;
